/*
* 文 件 名:  FastJsonSerializableTest.java
...
/**
*/
public class FastJsonSerializableTest {
    
    private Serializable fastjson = SerializableFactory.build(SERIALIZATIONTYPE.JSON_FASTJSON);
