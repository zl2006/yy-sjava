...
public class ClassPathScanHandler {
    ...
    public static void main(String[] args) {
        ...
        // 自定义过滤规则,搜索Action或Controller结尾的类
        List<String> classFilters = new ArrayList<String>();
        classFilters.add("*Action$");
        ...
        Set<Class<?>> calssList = handler.getPackageAllClasses("org.yy.framework.base.controller", true);
